<link rel="stylesheet" media="screen, print" href="<?=base_url()?>/frontend/css/tabulator.css">
<link href="<?=base_url()?>/frontend/css/tabulator.min.css" rel="stylesheet" />
<script src="<?=base_url()?>/frontend/js/tabulator.min.js"></script>
<div class="row">
    <div class="col-md-12">
        <button disabled type="button" class="btn btn-success btn-xs mr-2"><i class="fa fa-power-off fa-xs"></i></button> - Boton para Activar o Inactivar usuarios
        <br>
        <button disabled type="button" class="btn bg-orange btn-xs mr-2 mt-2"><i class="fa fa-edit fa-xs"></i></button> - Boton para editar el perfil del usuario
    </div>
</div>
<div class="row mt-5">
    <div class="col-md-12">

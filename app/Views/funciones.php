<script>
    ...
    async function cargando(t=0,fn=function(){},view=1){
        if(view==1){
            Swal.fire({
            html: '<div class="row"><div class="col-md-12"><img style="max-width:150px" src="<?=base_url()?>/frontend/img/spinner.gif" class="img"></div><div class="col-md-12"><p style="font-size:20px"><b>Cargando..</b></p></div></div>',

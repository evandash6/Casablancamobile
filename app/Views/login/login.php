...
<section class="login-clean" style="max-height: 100%;min-height: 100%;background: linear-gradient(-39deg, rgb(0,91,157) 45%, var(--white));border-bottom-style: none;min-width: 100%;max-width: 100%;">
        <form method="post" action="<?=base_url()?>/login/validar" style="max-width: 100%;min-width: 100%;background: rgba(255,255,255,0);margin-top: 10%;">
            ...
            <div class="form-group">
                <div class="container" style="margin-top: 40px;">
                    ...
                    <div class="form-row" style="border-bottom-style: solid;border-bottom-color: #ffffff;margin-top: 1rem;">
                        ...
                        <div class="col-11 col-md-6"><input class="form-control frm" type="password" required name="password" placeholder="Contraseña" style="background: rgba(247,249,252,0);color: rgb(255,255,255);border-bottom-style: none;"></div>
                    </div>
                </div>
            </div>
